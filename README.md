<img src="docs/aura-icon-new.svg" width="32" height="32" alt="Aura" style="vertical-align: middle; margin-right: 8px;" /> Aura
===
...
Aura is not code-signed yet, so your operating system will display a security warning the first time you open it.
...
1. Right-click (or Control-click) `Aura.app` in Finder.
...
3. You will see a message about Aura being blocked. Click **Open Anyway**.
...
- Chat data is stored in `~/.aura/aura.db` (or `./data/aura.db` in dev mode).
