...
Aura — Claude Code 的原生桌面 GUI 客户端，基于 Electron + Next.js。
...
- **Aura-{版本}-arm64.dmg** — macOS Apple Silicon (M1/M2/M3/M4)
- **Aura-{版本}-x64.dmg** — macOS Intel

## Installation

1. 下载对应芯片架构的 DMG 文件
2. 打开 DMG，将 Aura 拖入 Applications 文件夹
